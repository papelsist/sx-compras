...
class V33PdfGenerator {
     ...
     * @param xmlFile El archivo en binatio UTF-8 del comprobante
    ...
    static cargarParametrosAdicionales(Cfdi cfdi, Map parametros, boolean envio){
        switch (cfdi.origen) {
            case 'VENTA':
    ...
    static parametrosAdicionalesVenta(Cfdi cfdi, Map parametros, boolean envio ) {
