...
class ImportadorDeReqsuicionesDeCompras {
    ...
    ImportadorDeReqsuicionesDeCompras importarRequisiciones(Periodo periodo) {
        def select = """
    ...
    ImportadorDeReqsuicionesDeCompras importarEgresos(Periodo periodo){
    ...
    ImportadorDeReqsuicionesDeCompras importarCheques(Periodo periodo) {
        def c = RequisicionDeGastos.createCriteria()
