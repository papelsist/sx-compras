...
class CobranzaEfectivoTask implements  AsientoBuilder {
    ...
    String getTransferenciasDepositosSql() {
        ...
        ,b.forma_de_pago,'01' metodoDePago,b.id origen,x.numero documento,x.numero referenciaBancaria,b.importe total,0 diferencia,0 SAF        
        ,null ctaOrigen,x.banco_origen_id,(SELECT y.nombre FROM banco y where x.banco_origen_id=y.id) bancoOrigen,t.rfc,t.nombre cliente,null cxc_id,null factura,null tipo,null fecha_fac,null uuid,0 cobro_aplic,0 montoTotal
        ...
        ,concat('102-0001-',z.sub_cuenta_operativa,'-0000') cta_contable,concat('101-0003-',(case when s.clave>9 then '00' else '000' end),s.clave,'-0000') cta_contable2,z.numero ctaDestino,z.descripcion bancoDestino,'PAPEL SA DE CV' beneficiario
        ,'EFECTIVO' forma_de_pago,'01' metodoDePago,concat('Ficha: ',f.folio) origen,null documento,null referenciaBancaria,f.total,0 diferencia,0 SAF        
