...
abstract class VentasProc implements  ProcesadorMultipleDePolizas {
    ...
    String QUERY = """
        ...
        ,f.moneda,f.tipo_de_cambio as tc,f.subtotal,f.impuesto,f.descuento_importe,f.total,c.nombre referencia2,s.nombre sucursal, s.clave as suc, f.cliente_id as cliente
        ...
        UNION        
        SELECT concat('VENTAS_',f.tipo) as asiento,f.id as origen,f.tipo as documentoTipo,f.fecha,f.documento
        ,f.moneda,f.tipo_de_cambio,f.subtotal,f.impuesto,f.descuento_importe,f.total,c.nombre referencia2,s.nombre sucursal, s.clave as suc
    ...
    Poliza recalcular(Poliza poliza) {
       ...
       println "Recalculando poliza para arreglar el descuento pedido por el sat"
