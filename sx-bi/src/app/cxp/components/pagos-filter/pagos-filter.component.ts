...
@Component({
  ...
  <form [formGroup]="form">
    ...
    <mat-dialog-content>
      ...
      <div layout>
        <mat-slide-toggle formControlName="reciboPendiente" flex> Recibo pendiente </mat-slide-toggle>
        <mat-slide-toggle formControlName="porAplicar" flex> Por aplicar</mat-slide-toggle>
      </div>
...
export class PagosFilterComponent implements OnInit {
  title;
  form: FormGroup;
  filter: PagosFilter;
  ...
  constructor(
    ...
    this.title = data.title || 'Filtro de pagos';
