...
@Component({
  selector: 'sx-cliente-sin-ventas',
  template: `
...
export class ClienteSinVentasComponent implements OnInit {
  form: FormGroup;
  periodo: Periodo;
  title;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ClienteSinVentasComponent>,
