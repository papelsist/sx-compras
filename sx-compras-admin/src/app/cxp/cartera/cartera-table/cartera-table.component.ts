...
@Component({
  selector: 'sx-cartera-table',
  templateUrl: './cartera-table.component.html',
  styleUrls: ['./cartera-table.component.scss']
})
export class CarteraTableComponent extends LxTableComponent implements OnInit {
  totales = { registros: 0, total: 0.0 };
  ...
  buildGridOptions() {
    ...
    // this.gridOptions.pinnedBottomRowData = this.createFooterData();
