...
@Component({
  selector: 'sx-pagos-de-nomina-filter',
  template: `
  <form [formGroup]="form">
    ...
    <mat-dialog-content>
      ...
      <div layout="column">
        ...
        <mat-slide-toggle formControlName="pendientes">Pendientes</mat-slide-toggle>
      </div>
    </mat-dialog-content>
...
export class PagosDeNominaFilterComponent implements OnInit {
  title;
  form: FormGroup;
  ...
  constructor(
    ...
    this.title = data.title || 'Filtrar pagos de nómina';
